...
<body>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                <?php 
                while($doctor_lists = mysqli_fetch_assoc($doctors_list) )
                {
                ?>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item position-relative rounded overflow-hidden doctor_list_contains">
                        <div class="overflow-hidden doct_img_con">
                            <img class="img-fluid" src="img/team-1.jpg" alt="">
                        </div>
                        <div class="team-text bg-light text-center p-4">
                            <h5><?= $doctor_lists['doctor_name'] ?></h5>
                            <p class="text-primary doct_list">Experience: <?= $doctor_lists['experience'] ?></p>
                            <p class="text-primary doct_list">Department: <?= $doctor_lists['department'] ?></p>
                            <p class="text-primary doct_list">About: <?= $doctor_lists['description'] ?></p>
